...
def regax_context_menu(widget):
    ...
    actions = {
        ...
        "通过lovelypixelweaver打开程序内存(选择PID列,memprocfs途径)": widget.proc_to_lovelypixelweaver_memprocfs,
        "通过lovelypixelweaver打开程序内存(选择PID列,vol2途径,找不到内容试试这个)": widget.proc_to_lovelypixelweaver_vol2,
        "通过lovelypixelweaver打开程序内存(选择PID列,vol3途径)": widget.proc_to_lovelypixelweaver_vol3,
