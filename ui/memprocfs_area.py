...
class CollapsibleButtonGroup(QWidget):
    ...
    def show_context_menu(self, pos, button):
        context_menu = self.favorite_manager.create_context_menu(button, source_area="MemProcFS")
...
class MemProcFSArea(QWidget):
    ...
    def create_function_groups(self, layout):
        ...
        self.advanced_group = CollapsibleButtonGroup("时间线功能", advanced_buttons, self.favorite_manager)
        ...
        self.lovelymem_group = CollapsibleButtonGroup("快速检测", lovelymem_buttons, self.favorite_manager)
